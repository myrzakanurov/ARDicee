...
//  ARDicee
//
//  Created by Arman Myrzakanurov on 17.05.2021.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        if let touch = touches.first {
            let touchLocaition = touch.location(in: sceneView)
            
            let results = sceneView.hitTest(touchLocaition, types: .existingPlaneUsingExtent)
